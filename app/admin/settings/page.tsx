      ...
      <div className="sticky top-0 z-20 bg-white flex-shrink-0" style={{ boxShadow: "0 1px 0 #e5e7eb, 0 4px 16px rgba(0,0,0,0.04)" }}>
        ...
        <div className="px-6 md:px-8 py-3.5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-[17px] font-black text-gray-900 leading-tight tracking-tight">Platform Settings</h1>
            <p className="text-[11.5px] text-gray-400 mt-0.5 font-medium truncate">Defaults and integrations shared across every store</p>
          </div>
        </div>
      </div>
